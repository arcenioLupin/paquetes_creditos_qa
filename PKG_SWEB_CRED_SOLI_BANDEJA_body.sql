create or replace PACKAGE BODY       PKG_SWEB_CRED_SOLI_BANDEJA AS
  ...
  BEGIN
          ...
          SELECT
            ...
            FROM
               ...
               INNER JOIN vve_cred_soli_prof sp on sp.cod_soli_cred = sc.cod_soli_cred 
                                                   and sp.num_prof_veh in (select max(sp1.num_prof_veh) from vve_cred_soli_prof sp1 where sp1.cod_soli_cred = sc.cod_soli_cred and NVL(sp1.ind_inactivo,'N')  = 'N')
    ...
    SELECT
      ...
      WHERE 
       ...
       and (p_cod_estado is null or (p_cod_estado is not null and p_cod_estado = sc.cod_estado))
       --<I Req 87567 E2.2 LR 01.03.2021>
       --and ((pu.cod_id_perfil = v_perf_gf and u.txt_usuario = sc.cod_resp_fina) or (pu.cod_id_perfil <> v_perf_gf))  ASALASM PROY CREDITO F2
